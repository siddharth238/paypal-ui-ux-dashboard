...
<h4>This is my 2 day UI & UX dashboard project exclusively made for team Paypal to show case my Expertise in  UI & UX that includes CSS & SASS ,Javascript; to make the User Interface look more cool, Adobe Illustrator, Adobe Photoshop , Framer motion to give the the dynamic Animations. The Dashboard is made without any built-in CSS frameworks. The Website is still under update. The updated version will be deployed soon.. :)</h4>
